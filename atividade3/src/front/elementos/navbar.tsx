...
function Navbar() {
  useEffect(() => {
    ...
    if (petLoversText && petLoversText instanceof HTMLElement) {
      petLoversText.style.color = "white";
      petLoversText.style.fontWeight = "bold";
      petLoversText.style.fontSize = "20rem";
    }
  }, []);
