...
import ListaClientes5 from "../negocio/listagens/listagemConsumoEmValor";
import ListaClientes10 from "../negocio/listagens/listagemConsumoEmQuantidade";
...
console.log(`\nBem-vindo ao sistema de gerenciamento PetLovers!🐾`);
...
while (execucao) {
  ...
  console.log("\nListas🐾");
  console.log("19. Lista de produtos e serviços mais consumidos");
  console.log("20. 5 clientes que mais consumiram produtos(serviços em valor)");
  console.log("21. 10 clientes que mais consumiram produtos(serviços em quantidade)\n");
  console.log("***********************************************");
  ...
  switch (opcao) {
    ...
    case 18:
      ...
      filtraPet.atribuirServico(servicoEncontrado);
    ...
    default:
      console.log(`Peço desculpas, não compreendi :(`);
  }
}
